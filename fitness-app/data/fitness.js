...
const FITNESS_STORAGE_KEY = "fitnessData";
...
const getFitnessData = async () => {
  try {
    const storedData = await AsyncStorage.getItem(FITNESS_STORAGE_KEY);
    if (storedData) {
...
export { storeFitnessData, getFitnessData };
